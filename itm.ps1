...
function Get-Language($incomingSubtitle) {
    ...
    switch ($incomingSubtitle) {
        ...
        {$_ -like "*Estonia*"} {$fullstring += ("--language", "0:est", '--track-name', '0:[Estonia] Unstyled'); break }
        ...
        {$_ -like "*French(FR)*"} {$fullstring += ("--language", "0:fra", '--track-name', '0:[French] Unstyled'); break }
        ...
        {$_ -like "*Latvian*"} {$fullstring += ("--language", "0:lav", '--track-name', '0:[Latvian] Unstyled'); break }
        {$_ -like "*Lithuanian*"} {$fullstring += ("--language", "0:lit", '--track-name', '0:[Lithuanian] Unstyled'); break }
    ...
    $fullstring += $incomingSubtitle.FullName
    return $fullstring
}
